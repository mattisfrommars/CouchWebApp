...
$(function(){
    ...
    var requestProfessionalAgenda = function (event) {
        ...
        $.ajax(options).done(function (data) {
            ...
            var newHtml = renderProfessionalAgenda(data,$btn.attr("data-couch-session"));
    ...
    var renderProfessionalAgenda = function(data,id){
        ...
        for(var i = 0 ; i < data.length; i++){
            ...
            data[i].entries.forEach(function(element){
                ...
                btn.setAttribute("href", "/sessions/session/reschedule/agenda/"+ id +"/" + element.id);
